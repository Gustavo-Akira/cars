...
public class BrandController {
	...
	@PostMapping
	public ResponseEntity<BrandDTO> newBrand(@RequestBody BrandDTO brand) throws NotFoundException{
		return new ResponseEntity<>(brandService.saveBrand(brand,0L),HttpStatus.CREATED);
	}
	
	@PutMapping("/{brandId}")
	public ResponseEntity<BrandDTO> updateBrand(@PathVariable("brandId") Long brandId, @RequestBody BrandDTO brand) throws NotFoundException{
